...
namespace etud03._06._2017.hotel2DataSetTableAdapters {
...
SELECT id, name, surname, phone, birthdate FROM guest WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::etud03._06._2017.Properties.Settings.Default.hotel2ConnectionString;
        }
        ...
        public virtual int Fill(hotel2DataSet.guestDataTable dataTable) {
        ...
        public virtual hotel2DataSet.guestDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hotel2DataSet.guestDataTable dataTable = new hotel2DataSet.guestDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hotel2DataSet.guestDataTable dataTable) {
